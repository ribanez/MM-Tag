...
from src.process_data import bio_iob, iob_bio, bio_bioes, bioes_bio
...
class InputExample(object):
    ...
    def __init__(self, guid, sen, char, pos, chunk, label=None):
        ...
        :param guid: (string) Unique id for the example.
        :param sen: (array) with mapping words in sentences.
        :param char: (array) with arrays, mapping of chars in sentences.
        :param pos: (array) with mapping pos in sentence.
        :param chunk: (array) with mapping chunk in sentence.
        :param label: (array) with mapping labels in sentences.
        """
        self.guid = guid
        self.sen = sen
        self.label = label
    ...
    def __str__(self):
        """
        Method to representate InputExample like string
        :return: (string) representation of InputExample
        """
        return self.__repr__()

    def __repr__(self):
        """
        Method to create representation of InputExample
        :return: (string) representation of InputExample
        """
        s = ""
...
def create_examples(sen_list, ner_list, char_list, pos_list, chunk_list, set_type):
    ...
    :param sen_list: (array) with arrays of words sentences.
    :param ner_list: (array) with arrays of ners sentences.
    :param char_list: (array) with arrays of chars sentences.
    :param pos_list: (array) with arrays of pos sentences.
    :param chunk_list: (array) with arrays of chunks sentences.
    :param set_type: (string) to create GUID.
    :return: (array) of examples (InputExample objects)
    """
    examples = []
...
def load_data():
    """
    Helper to load data from pickle file (create with process_data.py)
    :return: all data.
    """
    print('Loading Data...')
...
def bio_to_spans(sequence, vocab, strict_iob2=False):
    """
    Helper to convert BIO to SPANS
    :param sequence: (array)
    :param vocab: (dict)
    :param strict_iob2: (boolean) active IOB2 type
    :return:
    """
    """
...
def batchify_with_label(words, chars, labels, n_gram=2, sorter=False):
    """
    Helper to create Batch with
    :param words:
    :param chars:
    :param labels:
    :param n_gram:
    :param sorter: (boolean) if True sorted the sentences from longer to short.
    :return:
    """
    """
